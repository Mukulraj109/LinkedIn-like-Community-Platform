      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white py-8 px-6 sm:px-10 shadow rounded-lg">
            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  onChange={handleChange}
                  className="block w-full px-3 py-2 pr-10 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            Demo credentials: <strong>admin@demo.com / password123</strong>
          </div>
        </div>
      </div>
    </div>
